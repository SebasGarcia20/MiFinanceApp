  ...
  return (
    ...
    >
      ...
      >
        <div className="p-6">
          <div className="mb-6">
            <h2 className="text-2xl font-bold text-accent-900 mb-1">Appearance</h2>
            ...
            <div>
              ...
              <div className="space-y-2">
                <button className="w-full flex items-center justify-between px-4 py-3 border-2 border-primary-400 rounded-lg bg-primary-50 text-left">
                  <div>
                    <div className="font-medium text-accent-900">Light</div>
                    <div className="text-xs text-accent-500">Default theme</div>
                  </div>
                ...
                <button className="w-full flex items-center justify-between px-4 py-3 border-2 border-accent-200 rounded-lg hover:bg-accent-50 text-left transition-colors">
                  <div>
                    <div className="font-medium text-accent-700">Dark</div>
                    <div className="text-xs text-accent-500">Coming soon</div>
                  </div>
